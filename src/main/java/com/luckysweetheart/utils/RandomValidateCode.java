...
public class RandomValidateCode {
    ...
    public void getRandcode(HttpServletRequest request,
        ...
        renderRandcode(request, response, RANDOMCODEKEY);
    }

    public void renderRandcode(HttpServletRequest request, HttpServletResponse response, String sessionKey){
        if(null == sessionKey)
            sessionKey = RANDOMCODEKEY;
        ...
        g.setColor(getRandColor(130, 153));
        //绘制干扰线
