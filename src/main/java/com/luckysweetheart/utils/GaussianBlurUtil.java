...
/**
 * Created by yangxin on 2017/9/19.
 */
public class GaussianBlurUtil {

    public static void main(String[] args) throws IOException {
        BufferedImage img = ImageIO.read(new File("C:\\Users\\dp\\Desktop\\图片\\IMG_2531.JPG"));
        long start = System.currentTimeMillis();
        img = blur(img, 170);
        long end = System.currentTimeMillis();

        ImageIO.write(img, "JPG", new File("C:\\Users\\dp\\Desktop\\图片\\test.JPG"));//保存为test.jpeg文件
